...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('order_status_list')->insert([
            ...
            ['id' => 6, 'orderstatuscode' => 6, 'orderstatus' => 'Back Ordered - Email Automatically Sent', 'sortorder' => 5.0, 'customerdisplay' => 'Your Order Is Back-Ordered (See Notes Below.)', 'Active' => 1, 'AdminDisplay' => 'Back-Ordered (PENDING)', 'created_at' => now(), 'updated_at' => now()],
