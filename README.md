...
| **Plugin System** | Display plugins (carousels, testimonials, events) rendered via shortcodes |
...
| **Global Settings** | Theme colors, dark/light mode, logos, fonts, storage backends |
