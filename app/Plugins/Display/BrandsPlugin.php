        ...
        try {
            ...
            if ($display === 'slider') {
                ...
                foreach ($brands as $brand) {
                    ...
                    $imgUrl   = $brand->brand_icon ?: ($brand->image_url ?? '') ?: ($brand->brand_logo_s3 ?? '') ?: 'https://via.placeholder.com/150x80?text=' . urlencode($brand->name);
                    ...
                    $html .= '<img src="' . e($imgUrl) . '" alt="' . e($brand->name) . '" class="h-12 max-w-full object-contain filter grayscale group-hover:grayscale-0 transition-all duration-300">';
                ...
                foreach ($brands as $brand) {
                    $brandUrl = route('shop.brand', $brand->slug);
                    $brandImg = $brand->brand_icon ?: ($brand->image_url ?? '');
                    ...
                    if ($brandImg) {
                        $html .= '<img src="' . e($brandImg) . '" alt="' . e($brand->name) . '" class="w-4 h-4 object-contain">';
                    }
