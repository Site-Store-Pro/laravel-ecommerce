                    ...
                    @foreach($items as $item)
                        ...
                        <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                            ...
                            <div class="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto">
                                @php
                                    $itemAttrs = json_decode($item->item_attributes, true) ?: [];
                                    $isDonationItem = !empty($itemAttrs['is_donation_or_bill_pay']);
                                @endphp
                                ...
                                @elseif($isDonationItem)
                                    <div class="px-3 py-1.5 bg-emerald-50 border border-emerald-200 rounded-xl text-xs font-bold text-emerald-800 whitespace-nowrap">
