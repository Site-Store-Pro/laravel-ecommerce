...
<div class="featured-items-plugin-section py-8" x-data>
                    ...
                    <div class="flex items-center gap-1.5 flex-wrap justify-end">
                        @if($product->quick_shop_active)
                            <button type="button"
                                    ...
                                    class="fi-btn bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 text-slate-800 dark:text-slate-100 rounded-xl px-2.5 py-1.5 text-xs font-bold transition flex items-center gap-1">
